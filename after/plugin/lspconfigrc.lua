...
local tailwindcss_colorizer_status, tailwindcss_colorizer = pcall(require, "tailwindcss-colorizer-cmp")
if not tailwindcss_colorizer_status then
	print("tailwindcss-colorizer-cmp is not installed")
	return
end
...
cmp.config.formatting = { format = tailwindcss_colorizer.formatter }
